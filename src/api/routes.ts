  ...
  router.get('/settings/models', async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const modelsByProvider: Record<string, Array<{ id: string; name: string; description?: string }>> = {
        gemini: [
          { id: 'gemini-3-pro-preview', name: 'Gemini 3 Pro (Preview)', description: 'Preview reasoning model', modality: 'multimodal', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'gemini-3-flash-preview', name: 'Gemini 3 Flash (Preview)', description: 'Preview fast model', modality: 'multimodal', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro', description: 'Latest reasoning model', modality: 'multimodal', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash', description: 'Fast multimodal model', modality: 'multimodal', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'gemini-2.5-flash-lite', name: 'Gemini 2.5 Flash Lite', description: 'Low-latency model', modality: 'multimodal', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
        ],
        anthropic: [
          { id: 'claude-opus-4-20250514', name: 'Claude Opus 4', description: 'Most capable', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'claude-sonnet-4-20250514', name: 'Claude Sonnet 4', description: 'Latest balanced model', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'claude-3-7-sonnet-20250219', name: 'Claude Sonnet 3.7', description: 'Reasoning + speed', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'claude-3-5-sonnet-20241022', name: 'Claude Sonnet 3.5', description: 'Fast and capable', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'claude-3-5-haiku-20241022', name: 'Claude Haiku 3.5', description: 'Fast and efficient', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
        ],
        openai: [
          { id: 'gpt-5.1', name: 'GPT-5.1', description: 'Flagship reasoning model', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'gpt-5.1-mini', name: 'GPT-5.1 Mini', description: 'Fast, cost-efficient', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'gpt-4.1', name: 'GPT-4.1', description: 'High-quality general model', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'gpt-4.1-mini', name: 'GPT-4.1 Mini', description: 'Balanced price/performance', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'gpt-4o', name: 'GPT-4o', description: 'Multimodal', modality: 'multimodal', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'gpt-4o-mini', name: 'GPT-4o Mini', description: 'Fast multimodal', modality: 'multimodal', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
        ],
        openrouter: [
          { id: 'anthropic/claude-opus-4-20250514', name: 'Claude Opus 4', description: 'Via OpenRouter', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'anthropic/claude-sonnet-4-20250514', name: 'Claude Sonnet 4', description: 'Via OpenRouter', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'openai/gpt-5.1', name: 'GPT-5.1', description: 'Via OpenRouter', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'openai/gpt-4.1', name: 'GPT-4.1', description: 'Via OpenRouter', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'google/gemini-2.5-pro', name: 'Gemini 2.5 Pro', description: 'Via OpenRouter', modality: 'multimodal', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'google/gemini-2.5-flash', name: 'Gemini 2.5 Flash', description: 'Via OpenRouter', modality: 'multimodal', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'meta-llama/llama-3-70b-instruct', name: 'Llama 3 70B', description: 'Meta via OpenRouter', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
          { id: 'mistralai/mixtral-8x22b', name: 'Mixtral 8x22B', description: 'Mistral via OpenRouter', modality: 'text', contextTokens: null, priceInputPerMTokens: null, priceOutputPerMTokens: null },
        ],
