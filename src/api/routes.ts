  ...
  router.get('/settings/models', async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const modelsByProvider: Record<string, Array<{ id: string; name: string; description?: string }>> = {
        gemini: [
          { id: 'gemini-3-pro-preview', name: 'Gemini 3 Pro (Preview)', description: 'Preview reasoning model' },
          ...
          { id: 'gemini-2.5-flash-lite', name: 'Gemini 2.5 Flash Lite', description: 'Low-latency model' },
        ],
        anthropic: [
          ...
          { id: 'claude-3-7-sonnet-20250219', name: 'Claude Sonnet 3.7', description: 'Reasoning + speed' },
          { id: 'claude-3-5-sonnet-20241022', name: 'Claude Sonnet 3.5', description: 'Fast and capable' },
          { id: 'claude-3-5-haiku-20241022', name: 'Claude Haiku 3.5', description: 'Fast and efficient' },
        ],
        openai: [
          { id: 'gpt-5.1', name: 'GPT-5.1', description: 'Flagship reasoning model' },
          { id: 'gpt-5.1-mini', name: 'GPT-5.1 Mini', description: 'Fast, cost-efficient' },
          { id: 'gpt-4.1', name: 'GPT-4.1', description: 'High-quality general model' },
          { id: 'gpt-4.1-mini', name: 'GPT-4.1 Mini', description: 'Balanced price/performance' },
          { id: 'gpt-4o', name: 'GPT-4o', description: 'Multimodal' },
          { id: 'gpt-4o-mini', name: 'GPT-4o Mini', description: 'Fast multimodal' },
        ],
        openrouter: [
          { id: 'anthropic/claude-opus-4-20250514', name: 'Claude Opus 4', description: 'Via OpenRouter' },
          ...
          { id: 'openai/gpt-4.1', name: 'GPT-4.1', description: 'Via OpenRouter' },
          ...
          { id: 'mistralai/mixtral-8x22b', name: 'Mixtral 8x22B', description: 'Mistral via OpenRouter' },
        ],
